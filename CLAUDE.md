...
- Delegate all code implementation tasks to `code-simplifier:code-simplifier` subagent (`subagent_type: "code-simplifier:code-simplifier"`) — research and planning can be done directly, but code changes must go through the subagent
