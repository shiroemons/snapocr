...
struct HotkeyRecorderView: View {
    ...
    private var recordButton: some View {
        ...
        .accessibilityLabel(
            isRecording
            ? String(localized: "Recording shortcut", comment: "Accessibility label when hotkey recorder is active")
            : String(localized: "Current shortcut: \(currentDisplayString)", comment: "Accessibility label showing current hotkey")
        )
    }

    private var resetButton: some View {
        Button(String(localized: "Reset to Default", comment: "Button to restore the default hotkey")) {
    ...
    private var buttonLabel: String {
        if isRecording {
            ...
            return String(localized: "Type shortcut...", comment: "Prompt shown in hotkey recorder while waiting for key input")
        }
...
#Preview {
    ...
    HotkeyRecorderView(keyCode: $keyCode, modifiers: $modifiers) { newKey, newMods in
